...
public record CreateOrderCommand (String customerId, String restaurantId, List<CreateOrderLineRequest> lines, Date orderdate, OrderStatus status, String deliverAddress) {
}
